...
async changePostProcessOllamaNumCtxSetting(numCtx: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_ollama_num_ctx_setting", { numCtx }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changePostProcessOllamaNumPredictSetting(numPredict: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_ollama_num_predict_setting", { numPredict }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changePostProcessLocalPerformanceSetting(preset: LocalLlmPerformancePreset) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_local_performance_setting", { preset }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changePostProcessLocalCtxSetting(ctx: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_local_ctx_setting", { ctx }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changePostProcessLocalMaxTokensSetting(maxTokens: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_local_max_tokens_setting", { maxTokens }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changePostProcessLocalTemperatureSetting(temperature: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_local_temperature_setting", { temperature }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changePostProcessLocalIdleShutdownMinutesSetting(minutes: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_local_idle_shutdown_minutes_setting", { minutes }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async getLocalLlmCatalog() : Promise<Result<LocalLlmModelInfo[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_local_llm_catalog") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async getLocalLlmRuntimeStatus() : Promise<Result<LocalLlmRuntimeStatus, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_local_llm_runtime_status") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async isLocalLlmModelDownloaded(tierId: string) : Promise<Result<boolean, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("is_local_llm_model_downloaded", { tierId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async downloadLocalLlmModel(tierId: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("download_local_llm_model", { tierId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
post_process_ollama_num_ctx?: number; 
/**
 * Max new tokens from Ollama (`num_predict`). `0` = omit (model default, no cap).
 */
post_process_ollama_num_predict?: number; post_process_local_performance?: LocalLlmPerformancePreset; 
/**
 * Context window (`-c`) for bundled `llama-server`. Clamped to
 * [`LOCAL_POST_PROCESS_CTX_MIN`], [`LOCAL_POST_PROCESS_CTX_MAX`].
 */
post_process_local_ctx?: number; 
/**
 * Max completion tokens for local server (`max_tokens`). `0` = omit (uncapped).
 */
post_process_local_max_tokens?: number; 
/**
 * Sampling temperature for local post-processing (OpenAI `temperature`).
 */
post_process_local_temperature?: number; 
/**
 * Minutes after a completed local post-process before stopping `llama-server`. `0` = keep running.
 */
post_process_local_idle_shutdown_minutes?: number; mute_while_recording?: boolean; append_trailing_space?: boolean; app_language?: string; experimental_enabled?: boolean; keyboard_implementation?: KeyboardImplementation; paste_delay_ms?: number }
...
export type LLMPrompt = { id: string; name: string; description?: string | null; prompt: string }
export type LocalLlmModelInfo = { tier_id: string; filename: string; size_mb: number }
/**
 * CPU/GPU trade-off for the bundled local summarization runtime (`llama-server`).
 */
export type LocalLlmPerformancePreset = "low" | "default" | "high"
export type LocalLlmRuntimeStatus = { ready: boolean; platform_supported: boolean }
